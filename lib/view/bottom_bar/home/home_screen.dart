          ...
          children: [
            ...
            Container(
              ...
              child: Obx(() => ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      final category = viewModel.projCategoriesList[index];
                      return GestureDetector(
                        onTap: () => viewModel.filterProjects(category),
                        child: Obx(() {
                          return Container(
                            padding: EdgeInsets.symmetric(horizontal: 10.w),
                            alignment: Alignment.center,
                            decoration: viewModel
                                        .homeSelectedProjectCat.value ==
                                    category
                                ? BoxDecoration(
                                    borderRadius: BorderRadius.circular(24.r),
                    ...
                    separatorBuilder: (BuildContext context, int index) =>
                        16.horizontalSpace,
                    itemCount: viewModel.projCategoriesList.length,
                  )),
            ),
            20.verticalSpace,
            Obx(() => SizedBox(
            ...
            Container(
              ...
              child: Obx(() => ListView.separated(
                    scrollDirection: Axis.horizontal,
                    itemBuilder: (BuildContext context, int index) {
                      final category = viewModel.associationCatsList[index];
                      return GestureDetector(
                        onTap: () => viewModel.filterHomeAssociations(category),
                        child: Obx(() {
                          return Container(
                            padding: EdgeInsets.symmetric(horizontal: 10.w),
                            alignment: Alignment.center,
                            decoration: viewModel
                                        .homeSelectedAssociationCat.value ==
                                    category
                                ? BoxDecoration(
                                    borderRadius: BorderRadius.circular(24.r),
                                    color: AppColors.secondaryDarkBrownColor
                    ...
                    separatorBuilder: (BuildContext context, int index) =>
                        16.horizontalSpace,
                    itemCount: viewModel.associationCatsList.length,
                  )),
            ),
            20.verticalSpace,
            Obx(() => SizedBox(
            ...
            Container(
              ...
              child: Obx(() => ListView.separated(
                    scrollDirection: Axis.horizontal,
                    itemBuilder: (BuildContext context, int index) {
                      final category = viewModel.servicesCategoriesList[index];
                      return GestureDetector(
                        onTap: () => viewModel.filterServices(category),
                        child: Obx(() {
                          return Container(
                            padding: EdgeInsets.symmetric(horizontal: 10.w),
                            alignment: Alignment.center,
                            decoration: viewModel.selectedServiceCat.value ==
                                    category
                                ? BoxDecoration(
                                    borderRadius: BorderRadius.circular(24.r),
                                    color: AppColors.secondaryDarkBrownColor
                    ...
                    separatorBuilder: (BuildContext context, int index) =>
                        16.horizontalSpace,
                    itemCount: viewModel.servicesCategoriesList.length,
                  )),
            ),
            20.verticalSpace,
            Obx(() => SizedBox(
